...
\input{content/08-communication.tex}
\input{content/09-platforms.tex}
\input{content/10-classification.tex}
\input{content/11-promises.tex}
\input{content/12-development.tex}
\input{content/13-practical-example.tex}
\input{content/14-existing-solutions.tex}
\input{content/15-use-cases.tex}
\input{content/16-setup.tex}
\input{content/17-features.tex}
\input{content/18-server.tex}
\input{content/19-limitations.tex}
\input{content/20-conclusions.tex}
\input{content/21-appendix.tex}
