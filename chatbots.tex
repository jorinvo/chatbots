...
% TODO: skip these 3 chapters for now, maybe I don't even need them
% \input{content/10-innovative-ideas.tex}
% \input{content/11-companies.tex}
% \input{content/12-usage.tex}
\input{content/13-promises.tex}
\input{content/14-development.tex}
\input{content/15-practical-example.tex}
\input{content/16-existing-solutions.tex}
\input{content/17-use-cases.tex}
\input{content/18-setup.tex}
\input{content/19-feature-implementation.tex}
% \input{content/20-technical-details.tex}
