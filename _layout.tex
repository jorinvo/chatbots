...
% PDF
\usepackage[ngerman,pdfauthor={Jorin Vogel}, pdfauthor={Jorin Vogel}, pdftitle={Chatbots: Development and Applications}, breaklinks=true]{hyperref}
...
%bild mit definierter Höhe
\newcommand{\bildh}[4]{
  \begin{figure}[H]
    \centering
      \vspace{1ex}
      \includegraphics[height=#2]{images/#1}
      \caption[#4]{\label{img.#1} #3}
    \vspace{1ex}
  \end{figure}
}
